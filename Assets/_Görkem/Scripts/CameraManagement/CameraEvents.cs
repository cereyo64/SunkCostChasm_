...
public class CameraEvents 
{
    ...
    public static event EventHandler<string> OnSwitchToCameraByName;
    ...
    public static void SwitchToCameraByName(string CameraName)
    {
        OnSwitchToCameraByName?.Invoke(null , CameraName );
    }
